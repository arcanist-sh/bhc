            ...
            for ext_sym in exts {
                ...
                match ext.status() {
                    ...
                    ast::ExtensionStatus::Unimplemented => {
                        ctx.warnings
                            .push(crate::LowerWarning::UnimplementedExtension {
...
fn register_standard_module_exports(
    ...
    let exports: &[&str] = match module_name {
        ...
        "Data.Sequence" => &[
            ...
            "|>",
            "><",
            // Pattern synonyms (Readers.HTML matches `... Seq.:<| rest`)
            ":<|",
            ":|>",
            "Empty",
            "take",
        ...
        "Data.Semigroup" => &[
            "(<>)", "sconcat", "stimes", // Min/Max wrappers
            "Min", "getMin", "Max", "getMax", // Arg
            "Arg", "First", "Last",
        ],
        "Control.Monad" => &[
            "when",
        ...
        "Data.Proxy" => &["Proxy", "asProxyTypeOf"],
        "Data.Void" => &["Void", "absurd", "vacuous"],
        "Data.Word" => &[
            "Word",
            "Word8",
            "Word16",
        ...
        "GHC.Generics" => &[
            "Generic", "Rep", "from", "to", "V1", "U1", "K1", "Rec0", "M1", "D1", "C1", "S1", "L1",
            "R1", ":+:", ":*:",
        ],
        ...
        "Control.Monad.Reader" | "Control.Monad.Reader.Class" | "Control.Monad.Trans.Reader" => &[
            "ReaderT",
            "Reader",
            "runReaderT",
            "runReader",
        ...
        "Control.Monad.Trans" | "Control.Monad.Trans.Class" => &["lift", "MonadTrans"],
        "Control.Monad.IO.Class" => &["liftIO", "MonadIO"],
        "Control.Monad.Identity" | "Data.Functor.Identity" => &["Identity", "runIdentity"],
        ...
        "System.Info" => &["os", "arch", "compilerName", "compilerVersion"],
        "System.Timeout" => &["timeout"],
        // === Data modules ===
        "Data.Functor" => &["<$>", "<$!>", "$>", "<&>", "void", "fmap"],
        "Data.Default" | "Data.Default.Class" => &["Default", "def"],
        "Data.Typeable" => &["Typeable", "typeOf", "typeRep", "cast", "Proxy"],
        "Data.Data" => &[
            "Data",
            "toConstr",
            "showConstr",
        ...
        "Data.List.NonEmpty" => &[
            "NonEmpty", "head", "tail", "last", "init", "toList", "nonEmpty", "fromList", "(<>)",
            "sconcat", "stimes", "map", "cons", "uncons", "unfoldr", "sort", "reverse", "length",
            "take", "drop", "filter", "group", "groupBy", "zip", "zipWith",
        ],
        "Data.Complex" => &[
            "Complex",
            "realPart",
        ...
        "Data.Unique" => &["Unique", "newUnique", "hashUnique"],
        "Data.Version" => &[
            "Version",
            "showVersion",
            "parseVersion",
        ...
        // === Control modules ===
        "Control.Monad.ST" => &["ST", "runST", "stToIO"],
        "Control.Arrow" => &[
            "Arrow",
            "ArrowChoice",
            "ArrowApply",
        ...
        "GHC.IO" | "GHC.IO.Handle" => &["IO", "Handle", "hFlush", "hClose"],
        "GHC.Base" => &[
            "id",
            "const",
            "flip",
        ...
        "GHC.Err" => &["error", "undefined", "errorWithoutStackTrace"],
        "GHC.List" => &[
            "map",
            "filter",
            "head",
        ...
        "Data.Text.Lazy.Encoding" => &["encodeUtf8", "decodeUtf8", "decodeUtf8'", "decodeUtf8With"],
        // =====================================================================
        ...
        "Text.DocLayout" => &[
            ...
            "nestle",
            "hang",
            // Doc constructors Writers.Markdown pattern-matches. NOTE: the
            // rest of the Doc ctor family (Text/Empty/NewLine) is deliberately
            // absent — `Text` would collide with the curated XML.Light `Text`
            // constructor via the unqualified indirection.
            "BlankLines",
            "CarriageReturn",
            "Concat",
            "vcat",
        ...
        "Text.Pandoc.Walk" => &["Walkable", "walk", "walkM", "query", "queryM"],
        ...
        "Text.Pandoc.Translations" => &["Term", "Translations", "lookupTerm", "readTranslations"],
        // =====================================================================
        // Parsec stubs
        // =====================================================================
        "Text.Parsec" => &[
        ...
        "Text.Parsec.String" | "Text.Parsec.Text" => &["Parser", "GenParser"],
        // =====================================================================
        // HTML TagSoup stubs
        // =====================================================================
        "Text.HTML.TagSoup" => &[
            ...
            "optRawTag",
            "optEscape",
            // ParseOptions (Readers.HTML updates the defaults record)
            "ParseOptions",
            "parseOptions",
            "optTagPosition",
            "optTagWarning",
        ...
        "Data.Containers.ListUtils" => &["nubOrd", "nubOrdOn", "nubInt", "nubIntOn"],
        // =====================================================================
        ...
        // Writers.HTML's variable-substituted table of contents walks the
        // template AST via `import qualified Text.DocTemplates.Internal as DT`.
        ...
        "Skylighting" | "Skylighting.Types" => &[
            ...
            "fromColor",
            "toColor",
            // Color constructor (Writers.Ms's `hexColor (RGB r g b)`)
            "RGB",
        ],
        "Skylighting.Parser" => &[
            "addSyntaxDefinition",
        ...
        "Text.TeXMath" | "Text.TeXMath.Types" => &[
            ...
            "writeTypst",
            "writeEqn",
            // Exp/Alignment/FractionType/InEDelimited ctors Readers.Typst.Math
            // builds (beyond the read/write functions above)
            "EGrouped",
            "EDelimited",
            "EFraction",
            "ESub",
        ...
        // =====================================================================
        "Text.Pandoc.Generic" => &["bottomUp", "topDown", "queryWith"],
        // =====================================================================
        // System extras stubs
        // =====================================================================
        "System.Random" => &[
        ...
        "System.CPUTime" => &["getCPUTime", "cpuTimePrecision"],
        ...
        "Data.Aeson.Encode.Pretty" => &[
            ...
            "Spaces",
            "Tab",
            // NumberFormat and its constructors
            "NumberFormat",
            "Generic",
            "Decimal",
            "Scientific",
        ...
        "Data.Ipynb" => &[
            ...
            "MarkdownCell",
            "RawCell",
            // Readers.Ipynb / Writers.Ipynb surface
            "Heading",
            "Markdown",
            "Raw",
            "Code",
        ...
        "Data.ByteString.Base64" => &["encode", "decode", "decodeLenient"],
        "Data.ByteString.Base64.Lazy" => &["encode", "decode", "decodeLenient"],
        "Data.Text.Normalize" => &[
            "normalize",
            "NormalizationMode",
            "NFC",
        ...
        "Control.Monad.RWS" => &[
            "RWS", "RWST", "runRWS", "evalRWS", "execRWS", "runRWST", "evalRWST", "execRWST",
            "ask", "asks", "tell", "get", "put", "modify", "reader", "writer", "state",
        ],
        // =====================================================================
        // Crypto.Hash stubs
        // =====================================================================
        ...
        "Citeproc" => &[
            ...
            "referenceType",
            "referenceVariables",
            // CitationItemType constructors (Readers.EndNote sets
            // `citationItemType = Citeproc.NormalCite`)
            "CitationItemType",
            "NormalCite",
            "AuthorOnly",
            "SuppressAuthor",
        ...
        // =====================================================================
        "Control.Monad.RWS.Strict" => &[
            "RWS", "RWST", "rws", "runRWS", "evalRWS", "execRWS", "runRWST", "evalRWST",
            "execRWST", "ask", "local", "asks", "tell", "listen", "pass", "censor", "get", "put",
            "modify", "gets",
        ],
        // =====================================================================
        // Network stubs
        ...
        "Network.Connection" => &["TLSSettings", "initConnectionContext", "ConnectionParams"],
        ...
        // Text.Blaze.Html re-exports the whole Text.Blaze surface in the real
        // blaze-html package — Writers.HTML gets `toValue`/`!`/`customAttribute`
        // etc. from `import Text.Blaze.Html hiding (contents)`.
        "Text.Blaze.Html" => &[
            "Html",
            "toHtml",
            "preEscapedToHtml",
        ...
        "System.X509" => &["getSystemCertificateStore", "CertificateStore"],
        "System.FilePath.Glob" => &["glob", "globDir", "globDir1", "compile", "match", "Pattern"],
        "GHC.IO.Exception" => &[
            "IOException",
            "IOError",
            "IOErrorType",
        ...
        "Text.TeXMath.Readers.OMML" => &["readOMML"],
        "Text.TeXMath.Readers.MathML.EntityMap" => &["getEntity", "entityMap", "getUnicode"],
        ...
        "Text.TeXMath.Shared" => &["getSpaceChars", "getLaTeXTextCommand"],
        "Text.XML.Light.Output" => &[
            "showElement",
            "showContent",
            "ppElement",
        ...
        // Typst stubs
        // =====================================================================
        "Typst" => &["parseTypst", "evaluateTypst"],
        "Typst.Types" => &[
            "Val",
            "Content",
            "Selector",
        ...
        "Typst.Methods" => &["applyPureFunction", "lookupMethod", "formatNumber"],
        // =====================================================================
        // Jira stubs
        // =====================================================================
        "Text.Jira.Parser" => &["parse", "doc", "plainText"],
        "Text.Jira.Printer" => &[
            "prettyBlocks",
            "prettyBlock",
            "prettyInlines",
        ...
        // Full jira-wiki-markup surface used by Readers.Jira/Writers.Jira.
        // NOTE: this module is on the dedicated-stub path (see the Djot branch
        // in register_module_stub_exports) — many of these names (Str, Space,
        // Citation, Table, ...) collide with pandoc-types constructors and must
        // not resolve through the unqualified indirection.
        "Text.Jira.Markup" => &[
            "Doc",
            "Block",
            "Inline",
        ...
        // Haddock stubs
        // =====================================================================
        "Documentation.Haddock.Parser" => &["parseParas", "parseString", "toRegular"],
        ...
        "Data.Yaml.Internal" => &[
            "rawParser",
            "parseRawDoc",
            // Readers.Metadata's yamlBsToMeta pipeline
            "decodeAllHelper",
            "Warning",
            "DuplicateKey",
        ],
        ...
        // =====================================================================
        "Paths_pandoc" => &["version", "getDataDir", "getDataFileName"],
        // =====================================================================
        // Unicode
        // =====================================================================
        "Unicode.Char" => &[
        ...
        // Powerpoint output
        // =====================================================================
        "Text.Pandoc.Writers.Powerpoint.Output" => &["presentationToArchive"],
        // =====================================================================
        // aeson (extended)
        // =====================================================================
        "Data.Aeson.Key" => &["Key", "fromText", "toText", "fromString"],
        "Data.Aeson.KeyMap" => &[
            "KeyMap",
            "empty",
            "singleton",
        ...
        "Options.Applicative.Common" => &["runParser", "evalParser"],
        "Options.Applicative.Help" => &["renderHelp"],
    ...
    for &raw_export in exports {
        ...
        if has_typed_sigs {
            ...
            // The Blaze element/attribute modules are full of names that
            // collide with Prelude builtins — `H.div` resolved to integer
            // `div :: a -> a -> a` (so `secttag $ x` failed as a partial
            // application in Writers.HTML), plus `head`/`span`/`id`/`min`/
            // `max`/`length`. They are only ever imported qualified.
            || module_name == "Text.Blaze.XHtml5"
            || module_name == "Text.Blaze.XHtml1.Transitional"
            || module_name == "Text.Blaze.XHtml5.Attributes"
            || module_name == "Text.Blaze.XHtml1.Transitional.Attributes"
            // haddock-library's Table/Header/Example/Picture records collide
                ...
                ))
        {
            ...
            //
            // Citeproc's `Citation` record has the same hazard against
            // pandoc-types' unrelated `Citation` constructor: with
            // Text.Pandoc.Definition in scope the indirection resolved
            // `Citeproc.Citation{..}` to the real pandoc-types constructor
            // (Readers.EndNote: `expected (Citeproc.Citation Text), found
            // Citation`). Only the colliding export gets a dedicated stub; the
            // rest of the Citeproc lists keep the shared-name wiring.
            let full_qualified = Symbol::intern(&format!("{module_name}.{export}"));
            if ctx.lookup_value(aliased_qualified).is_none() {
...
fn lower_decl(ctx: &mut LowerContext, decl: &ast::Decl) -> LowerResult<Vec<hir::Item>> {
    match decl {
        ...
        ast::Decl::StandaloneDeriving(sd) => {
            ...
            Ok(vec![hir::Item::StandaloneDeriving(
                hir::StandaloneDeriving {
                    class,
                    type_name,
                    span: sd.span,
                },
...
fn ensure_tuple_constructor(ctx: &mut LowerContext, arity: usize, span: Span) -> hir::DefId {
    let tuple_sym = Symbol::intern(&format!("({})", ",".repeat(arity.saturating_sub(1))));
...
fn lower_fun_bind(ctx: &mut LowerContext, fun_bind: &ast::FunBind) -> LowerResult<hir::ValueDef> {
    ...
    let sig = ctx
        .lookup_type_signature(name)
        .cloned()
        .map(|ty| lower_type_to_scheme(ctx, &ty));
                        ...
                        if !fb.clauses.is_empty() && !fb.clauses[0].pats.is_empty() {
                            ...
                            for clause in &fb.clauses {
                                ...
                                let pat = if clause.pats.len() == 1 {
                                    ...
                                    let tuple_def_id =
                                        ensure_tuple_constructor(ctx, clause.pats.len(), fb.span);
                                ...
                                let body = if clause.wheres.is_empty() {
                                    ...
                                    let wbs: Vec<hir::Binding> = clause
                                        .wheres
                                        .iter()
                                        .filter_map(|wd| {
                                            if let ast::Decl::FunBind(wfb) = wd {
                ...
                Some(
                    sig.names
                        ...
                        .map(|n| hir::MethodSig {
                            ...
                            id: ctx
                                .lookup_value(n.name)
                                .unwrap_or_else(|| ctx.fresh_def_id()),
