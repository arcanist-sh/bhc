...
fn register_standard_module_exports(
    ...
    let exports: &[&str] = match module_name {
        ...
        "Text.TeXMath.Readers.MathML.EntityMap" => &["getEntity", "entityMap"],
        "Text.TeXMath.Unicode.ToTeX" => &["toTeX", "toUnicode", "getTeXMath", "lookupChar"],
        ...
        "Typst.Methods" => &["applyPureFunction", "lookupMethod"],
        // =====================================================================
        // Jira stubs
        // =====================================================================
        "Text.Jira.Parser" => &["parse", "doc"],
        "Text.Jira.Printer" => &[
            "prettyBlocks",
            "prettyBlock",
            "prettyInlines",
        ...
        // Haddock stubs
        // =====================================================================
        "Documentation.Haddock.Parser" => &["parseParas", "parseString"],
        ...
        // Yaml stubs
        // =====================================================================
        "Data.Yaml.Internal" => &["rawParser", "parseRawDoc"],
        "Text.Libyaml" => &[
            "Event",
            "Style",
            "Tag",
