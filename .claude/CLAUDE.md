...
**Notes:** 172 E2E tests passing across 70 milestones (E.1–E.70). See `.claude/TODO-pandoc.md` for detailed Pandoc roadmap and `.claude/ROADMAP.md` for M11 tracking.
