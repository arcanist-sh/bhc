...
| 9.7 Core IR Optimizer | 🟡 | Core simplifier (E.68-E.69): constant folding, beta reduction, case-of-known-constructor, case-of-case, local+top-level dead/inline; top-level inlining (cheap-only, protected names skipped), export-aware dead elimination; pattern match compilation, demand analysis, dictionary specialization not started |
...
**Notes:** 168 E2E tests passing across 68 milestones. See `.claude/TODO-pandoc.md` for detailed Pandoc roadmap and `.claude/ROADMAP.md` for M11 tracking.
