...
// Laziness: an argument or constructor field the program never uses must not
// be evaluated. `expected.txt` for all four was generated by GHC, not written
// by hand — the point of the family is that Haskell decides, not BHC.
#[test]
fn test_tier2_lazy_unused_arg_native() {
    run_native_test("tier2_functions/lazy_unused_arg", Profile::Default);
}

#[test]
fn test_tier2_lazy_con_field_native() {
    run_native_test("tier2_functions/lazy_con_field", Profile::Default);
}

#[test]
fn test_tier2_lazy_const_native() {
    run_native_test("tier2_functions/lazy_const", Profile::Default);
}

#[test]
fn test_tier2_lazy_infinite_native() {
